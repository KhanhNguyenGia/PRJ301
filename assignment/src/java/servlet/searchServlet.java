    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                out.println("<p>The website is deployed in " + country + "</p>");
                ServletConfig con = getServletConfig();
                String language = con.getInitParameter("language");
                out.println("<p>The language used is " + language + "</p>");
                out.println("<table class='producttable'>");
                out.println("<thead><td>product</td><td>name</td><td>price</td><td>image</td><td>detail</td><td colspan='2'>action</td></thead>");
